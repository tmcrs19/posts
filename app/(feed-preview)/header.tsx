  ...
  return (
    <header className="bg-gray-200 fixed bottom-0 md:top-0 md:left-0 md:bottom-auto w-full md:w-1/6 lg:w-1/4 flex-shrink-0 z-3">
      <div className="p-2 flex md:flex-col h-full md:h-screen justify-between md:justify-start">
        <nav className="flex-1 flex md:flex-col items-center md:items-center lg:items-end lg:ml-auto lg:pr-4 space-x-4 md:space-x-0 md:space-y-4">
          <Link
            href="/"
          ...
          >
            ...
            <span className="hidden lg:inline-block lg:ml-2">
              Jobs search
            </span>
          </Link>
        </nav>
